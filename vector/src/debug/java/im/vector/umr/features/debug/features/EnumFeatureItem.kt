...
package im.vector.umr.features.debug.features
...
abstract class EnumFeatureItem : VectorEpoxyModel<EnumFeatureItem.Holder>(R.layout.item_feature) {
    ...
    class Holder : VectorEpoxyHolder() {
        val label by bind<TextView>(im.vector.umr.R.id.feature_label)
        val optionsSpinner by bind<Spinner>(im.vector.umr.R.id.feature_options)
    }
