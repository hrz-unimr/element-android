...
class KeyStoreCryptoLegacyImplTests {

    private val keyStoreCryptoLegacyImpl = KeyStoreCryptoLegacyImpl(InstrumentationRegistry.getInstrumentation().context, LockScreenTestConstants.ALIAS)
    ...
    fun checkEncryptionAndDecryptionWorkAsExpected() {
        ...
        val encryptedBytes = keyStoreCryptoLegacyImpl.encrypt(original)
