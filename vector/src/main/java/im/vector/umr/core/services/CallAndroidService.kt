...
package im.vector.umr.core.services
...
import im.vector.umr.features.call.CallArgs
import im.vector.umr.features.call.VectorCallActivity
import im.vector.umr.features.call.telecom.CallConnection
import im.vector.umr.features.call.webrtc.WebRtcCall
import im.vector.umr.features.call.webrtc.WebRtcCallManager
import im.vector.umr.features.call.webrtc.getOpponentAsMatrixItem
...
import im.vector.umr.features.popup.IncomingCallAlert
...
class CallAndroidService : VectorAndroidService() {
    ...
    companion object {
        ...
        private const val ACTION_INCOMING_RINGING_CALL = "im.vector.umr.core.services.CallService.ACTION_INCOMING_RINGING_CALL"
        private const val ACTION_OUTGOING_RINGING_CALL = "im.vector.umr.core.services.CallService.ACTION_OUTGOING_RINGING_CALL"
        private const val ACTION_ONGOING_CALL = "im.vector.umr.core.services.CallService.ACTION_ONGOING_CALL"
        private const val ACTION_CALL_TERMINATED = "im.vector.umr.core.services.CallService.ACTION_CALL_TERMINATED"
