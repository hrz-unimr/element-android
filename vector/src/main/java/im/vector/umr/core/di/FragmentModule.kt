...
import im.vector.umr.features.analytics.ui.consent.AnalyticsOptInFragment
import im.vector.umr.features.attachments.preview.AttachmentsPreviewFragment
import im.vector.umr.features.contactsbook.ContactsBookFragment
import im.vector.umr.features.crypto.keysbackup.settings.KeysBackupSettingsFragment
import im.vector.umr.features.crypto.quads.SharedSecuredStorageKeyFragment
import im.vector.umr.features.crypto.quads.SharedSecuredStoragePassphraseFragment
import im.vector.umr.features.crypto.quads.SharedSecuredStorageResetAllFragment
import im.vector.umr.features.crypto.recover.BootstrapConclusionFragment
import im.vector.umr.features.crypto.recover.BootstrapConfirmPassphraseFragment
import im.vector.umr.features.crypto.recover.BootstrapEnterPassphraseFragment
import im.vector.umr.features.crypto.recover.BootstrapMigrateBackupFragment
import im.vector.umr.features.crypto.recover.BootstrapReAuthFragment
import im.vector.umr.features.crypto.recover.BootstrapSaveRecoveryKeyFragment
import im.vector.umr.features.crypto.recover.BootstrapSetupRecoveryKeyFragment
import im.vector.umr.features.crypto.recover.BootstrapWaitingFragment
import im.vector.umr.features.crypto.verification.QuadSLoadingFragment
import im.vector.umr.features.crypto.verification.cancel.VerificationCancelFragment
import im.vector.umr.features.crypto.verification.cancel.VerificationNotMeFragment
import im.vector.umr.features.crypto.verification.choose.VerificationChooseMethodFragment
import im.vector.umr.features.crypto.verification.conclusion.VerificationConclusionFragment
import im.vector.umr.features.crypto.verification.emoji.VerificationEmojiCodeFragment
import im.vector.umr.features.crypto.verification.qrconfirmation.VerificationQRWaitingFragment
import im.vector.umr.features.crypto.verification.qrconfirmation.VerificationQrScannedByOtherFragment
import im.vector.umr.features.crypto.verification.request.VerificationRequestFragment
import im.vector.umr.features.devtools.RoomDevToolEditFragment
import im.vector.umr.features.devtools.RoomDevToolFragment
import im.vector.umr.features.devtools.RoomDevToolSendFormFragment
import im.vector.umr.features.devtools.RoomDevToolStateEventListFragment
import im.vector.umr.features.discovery.DiscoverySettingsFragment
import im.vector.umr.features.discovery.change.SetIdentityServerFragment
import im.vector.umr.features.home.HomeDetailFragment
import im.vector.umr.features.home.HomeDrawerFragment
import im.vector.umr.features.home.LoadingFragment
import im.vector.umr.features.home.NewHomeDetailFragment
import im.vector.umr.features.home.room.breadcrumbs.BreadcrumbsFragment
import im.vector.umr.features.home.room.detail.TimelineFragment
import im.vector.umr.features.home.room.detail.search.SearchFragment
import im.vector.umr.features.home.room.list.RoomListFragment
import im.vector.umr.features.home.room.list.home.HomeRoomListFragment
import im.vector.umr.features.home.room.threads.list.views.ThreadListFragment
import im.vector.umr.features.location.LocationSharingFragment
import im.vector.umr.features.location.preview.LocationPreviewFragment
import im.vector.umr.features.login.LoginCaptchaFragment
import im.vector.umr.features.login.LoginFragment
import im.vector.umr.features.login.LoginGenericTextInputFormFragment
import im.vector.umr.features.login.LoginResetPasswordFragment
import im.vector.umr.features.login.LoginResetPasswordMailConfirmationFragment
import im.vector.umr.features.login.LoginResetPasswordSuccessFragment
import im.vector.umr.features.login.LoginServerSelectionFragment
import im.vector.umr.features.login.LoginServerUrlFormFragment
import im.vector.umr.features.login.LoginSignUpSignInSelectionFragment
import im.vector.umr.features.login.LoginSplashFragment
import im.vector.umr.features.login.LoginWaitForEmailFragment
import im.vector.umr.features.login.LoginWebFragment
import im.vector.umr.features.login.terms.LoginTermsFragment
import im.vector.umr.features.login2.LoginCaptchaFragment2
import im.vector.umr.features.login2.LoginFragmentSigninPassword2
import im.vector.umr.features.login2.LoginFragmentSigninUsername2
import im.vector.umr.features.login2.LoginFragmentSignupPassword2
import im.vector.umr.features.login2.LoginFragmentSignupUsername2
import im.vector.umr.features.login2.LoginFragmentToAny2
import im.vector.umr.features.login2.LoginGenericTextInputFormFragment2
import im.vector.umr.features.login2.LoginResetPasswordFragment2
import im.vector.umr.features.login2.LoginResetPasswordMailConfirmationFragment2
import im.vector.umr.features.login2.LoginResetPasswordSuccessFragment2
import im.vector.umr.features.login2.LoginServerSelectionFragment2
import im.vector.umr.features.login2.LoginServerUrlFormFragment2
import im.vector.umr.features.login2.LoginSplashSignUpSignInSelectionFragment2
import im.vector.umr.features.login2.LoginSsoOnlyFragment2
import im.vector.umr.features.login2.LoginWaitForEmailFragment2
import im.vector.umr.features.login2.LoginWebFragment2
import im.vector.umr.features.login2.created.AccountCreatedFragment
import im.vector.umr.features.login2.terms.LoginTermsFragment2
import im.vector.umr.features.matrixto.MatrixToRoomSpaceFragment
import im.vector.umr.features.matrixto.MatrixToUserFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthAccountCreatedFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthCaptchaFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthChooseDisplayNameFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthChooseProfilePictureFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthCombinedLoginFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthCombinedRegisterFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthCombinedServerSelectionFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthEmailEntryFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthGenericTextInputFormFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthLegacyStyleCaptchaFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthLegacyWaitForEmailFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthLoginFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthPersonalizationCompleteFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthPhoneConfirmationFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthPhoneEntryFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthResetPasswordFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthResetPasswordMailConfirmationFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthResetPasswordSuccessFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthServerSelectionFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthSignUpSignInSelectionFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthSplashCarouselFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthSplashFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthUseCaseFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthWaitForEmailFragment
import im.vector.umr.features.onboarding.ftueauth.FtueAuthWebFragment
import im.vector.umr.features.onboarding.ftueauth.terms.FtueAuthLegacyStyleTermsFragment
import im.vector.umr.features.onboarding.ftueauth.terms.FtueAuthTermsFragment
import im.vector.umr.features.pin.PinFragment
import im.vector.umr.features.poll.create.CreatePollFragment
import im.vector.umr.features.qrcode.QrCodeScannerFragment
import im.vector.umr.features.reactions.EmojiChooserFragment
import im.vector.umr.features.reactions.EmojiSearchResultFragment
import im.vector.umr.features.roomdirectory.PublicRoomsFragment
import im.vector.umr.features.roomdirectory.createroom.CreateRoomFragment
import im.vector.umr.features.roomdirectory.picker.RoomDirectoryPickerFragment
import im.vector.umr.features.roomdirectory.roompreview.RoomPreviewNoPreviewFragment
import im.vector.umr.features.roommemberprofile.RoomMemberProfileFragment
import im.vector.umr.features.roommemberprofile.devices.DeviceListFragment
import im.vector.umr.features.roommemberprofile.devices.DeviceTrustInfoActionFragment
import im.vector.umr.features.roomprofile.RoomProfileFragment
import im.vector.umr.features.roomprofile.alias.RoomAliasFragment
import im.vector.umr.features.roomprofile.banned.RoomBannedMemberListFragment
import im.vector.umr.features.roomprofile.members.RoomMemberListFragment
import im.vector.umr.features.roomprofile.notifications.RoomNotificationSettingsFragment
import im.vector.umr.features.roomprofile.permissions.RoomPermissionsFragment
import im.vector.umr.features.roomprofile.settings.RoomSettingsFragment
import im.vector.umr.features.roomprofile.settings.joinrule.RoomJoinRuleFragment
import im.vector.umr.features.roomprofile.settings.joinrule.advanced.RoomJoinRuleChooseRestrictedFragment
import im.vector.umr.features.roomprofile.uploads.RoomUploadsFragment
import im.vector.umr.features.roomprofile.uploads.files.RoomUploadsFilesFragment
import im.vector.umr.features.roomprofile.uploads.media.RoomUploadsMediaFragment
import im.vector.umr.features.settings.VectorSettingsGeneralFragment
import im.vector.umr.features.settings.VectorSettingsHelpAboutFragment
import im.vector.umr.features.settings.VectorSettingsLabsFragment
import im.vector.umr.features.settings.VectorSettingsPinFragment
import im.vector.umr.features.settings.VectorSettingsPreferencesFragment
import im.vector.umr.features.settings.VectorSettingsSecurityPrivacyFragment
import im.vector.umr.features.settings.account.deactivation.DeactivateAccountFragment
import im.vector.umr.features.settings.crosssigning.CrossSigningSettingsFragment
import im.vector.umr.features.settings.devices.VectorSettingsDevicesFragment
import im.vector.umr.features.settings.devtools.AccountDataFragment
import im.vector.umr.features.settings.devtools.GossipingEventsPaperTrailFragment
import im.vector.umr.features.settings.devtools.IncomingKeyRequestListFragment
import im.vector.umr.features.settings.devtools.KeyRequestsFragment
import im.vector.umr.features.settings.devtools.OutgoingKeyRequestListFragment
import im.vector.umr.features.settings.font.FontScaleSettingFragment
import im.vector.umr.features.settings.homeserver.HomeserverSettingsFragment
import im.vector.umr.features.settings.ignored.VectorSettingsIgnoredUsersFragment
import im.vector.umr.features.settings.legals.LegalsFragment
import im.vector.umr.features.settings.locale.LocalePickerFragment
import im.vector.umr.features.settings.notifications.VectorSettingsAdvancedNotificationPreferenceFragment
import im.vector.umr.features.settings.notifications.VectorSettingsNotificationPreferenceFragment
import im.vector.umr.features.settings.notifications.VectorSettingsNotificationsTroubleshootFragment
import im.vector.umr.features.settings.push.PushGatewaysFragment
import im.vector.umr.features.settings.push.PushRulesFragment
import im.vector.umr.features.settings.threepids.ThreePidsSettingsFragment
import im.vector.umr.features.share.IncomingShareFragment
import im.vector.umr.features.signout.soft.SoftLogoutFragment
import im.vector.umr.features.spaces.SpaceListFragment
import im.vector.umr.features.spaces.create.ChoosePrivateSpaceTypeFragment
import im.vector.umr.features.spaces.create.ChooseSpaceTypeFragment
import im.vector.umr.features.spaces.create.CreateSpaceAdd3pidInvitesFragment
import im.vector.umr.features.spaces.create.CreateSpaceDefaultRoomsFragment
import im.vector.umr.features.spaces.create.CreateSpaceDetailsFragment
import im.vector.umr.features.spaces.explore.SpaceDirectoryFragment
import im.vector.umr.features.spaces.leave.SpaceLeaveAdvancedFragment
import im.vector.umr.features.spaces.manage.SpaceAddRoomFragment
import im.vector.umr.features.spaces.manage.SpaceManageRoomsFragment
import im.vector.umr.features.spaces.manage.SpaceSettingsFragment
import im.vector.umr.features.spaces.people.SpacePeopleFragment
import im.vector.umr.features.spaces.preview.SpacePreviewFragment
import im.vector.umr.features.terms.ReviewTermsFragment
import im.vector.umr.features.usercode.ShowUserCodeFragment
import im.vector.umr.features.userdirectory.UserListFragment
import im.vector.umr.features.widgets.WidgetFragment
