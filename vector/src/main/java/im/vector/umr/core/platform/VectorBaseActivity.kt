...
package im.vector.umr.core.platform
...
import im.vector.umr.core.di.ActivityEntryPoint
import im.vector.umr.core.dialogs.DialogLocker
import im.vector.umr.core.dialogs.UnrecognizedCertificateDialog
import im.vector.umr.core.error.fatalError
import im.vector.umr.core.extensions.observeEvent
import im.vector.umr.core.extensions.observeNotNull
import im.vector.umr.core.extensions.registerStartForActivityResult
import im.vector.umr.core.extensions.restart
...
import im.vector.umr.core.utils.AndroidSystemSettingsProvider
import im.vector.umr.core.utils.ToolbarConfig
...
import im.vector.umr.features.configuration.VectorConfiguration
import im.vector.umr.features.consent.ConsentNotGivenHelper
...
import im.vector.umr.features.pin.UnlockedActivity
import im.vector.umr.features.rageshake.BugReportActivity
import im.vector.umr.features.rageshake.BugReporter
import im.vector.umr.features.rageshake.RageShake
import im.vector.umr.features.session.SessionListener
import im.vector.umr.features.settings.FontScalePreferences
import im.vector.umr.features.settings.FontScalePreferencesImpl
import im.vector.umr.features.settings.VectorPreferences
import im.vector.umr.features.themes.ActivityOtherThemes
import im.vector.umr.features.themes.ThemeUtils
import im.vector.umr.receivers.DebugReceiver
