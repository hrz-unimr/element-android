...
import im.vector.umr.features.analytics.accountdata.AnalyticsAccountDataViewModel
import im.vector.umr.features.analytics.ui.consent.AnalyticsConsentViewModel
import im.vector.umr.features.auth.ReAuthViewModel
import im.vector.umr.features.call.VectorCallViewModel
import im.vector.umr.features.call.conference.JitsiCallViewModel
import im.vector.umr.features.call.transfer.CallTransferViewModel
import im.vector.umr.features.contactsbook.ContactsBookViewModel
import im.vector.umr.features.createdirect.CreateDirectRoomViewModel
import im.vector.umr.features.crypto.keysbackup.settings.KeysBackupSettingsViewModel
import im.vector.umr.features.crypto.quads.SharedSecureStorageViewModel
import im.vector.umr.features.crypto.recover.BootstrapSharedViewModel
import im.vector.umr.features.crypto.verification.VerificationBottomSheetViewModel
import im.vector.umr.features.crypto.verification.choose.VerificationChooseMethodViewModel
import im.vector.umr.features.crypto.verification.emoji.VerificationEmojiCodeViewModel
import im.vector.umr.features.devtools.RoomDevToolViewModel
import im.vector.umr.features.discovery.DiscoverySettingsViewModel
import im.vector.umr.features.discovery.change.SetIdentityServerViewModel
import im.vector.umr.features.home.HomeActivityViewModel
import im.vector.umr.features.home.HomeDetailViewModel
import im.vector.umr.features.home.UnknownDeviceDetectorSharedViewModel
import im.vector.umr.features.home.UnreadMessagesSharedViewModel
import im.vector.umr.features.home.UserColorAccountDataViewModel
import im.vector.umr.features.home.room.breadcrumbs.BreadcrumbsViewModel
import im.vector.umr.features.home.room.detail.TimelineViewModel
import im.vector.umr.features.home.room.detail.composer.MessageComposerViewModel
import im.vector.umr.features.home.room.detail.search.SearchViewModel
import im.vector.umr.features.home.room.detail.timeline.action.MessageActionsViewModel
import im.vector.umr.features.home.room.detail.timeline.edithistory.ViewEditHistoryViewModel
import im.vector.umr.features.home.room.detail.timeline.reactions.ViewReactionsViewModel
import im.vector.umr.features.home.room.detail.upgrade.MigrateRoomViewModel
import im.vector.umr.features.home.room.list.RoomListViewModel
import im.vector.umr.features.home.room.list.home.HomeRoomListViewModel
import im.vector.umr.features.homeserver.HomeServerCapabilitiesViewModel
import im.vector.umr.features.invite.InviteUsersToRoomViewModel
import im.vector.umr.features.location.LocationSharingViewModel
import im.vector.umr.features.location.live.map.LiveLocationMapViewModel
import im.vector.umr.features.location.preview.LocationPreviewViewModel
import im.vector.umr.features.login.LoginViewModel
import im.vector.umr.features.login2.LoginViewModel2
import im.vector.umr.features.login2.created.AccountCreatedViewModel
import im.vector.umr.features.matrixto.MatrixToBottomSheetViewModel
import im.vector.umr.features.media.VectorAttachmentViewerViewModel
import im.vector.umr.features.onboarding.OnboardingViewModel
import im.vector.umr.features.poll.create.CreatePollViewModel
import im.vector.umr.features.qrcode.QrCodeScannerViewModel
import im.vector.umr.features.rageshake.BugReportViewModel
import im.vector.umr.features.reactions.EmojiSearchResultViewModel
import im.vector.umr.features.room.RequireActiveMembershipViewModel
import im.vector.umr.features.roomdirectory.RoomDirectoryViewModel
import im.vector.umr.features.roomdirectory.createroom.CreateRoomViewModel
import im.vector.umr.features.roomdirectory.picker.RoomDirectoryPickerViewModel
import im.vector.umr.features.roomdirectory.roompreview.RoomPreviewViewModel
import im.vector.umr.features.roommemberprofile.RoomMemberProfileViewModel
import im.vector.umr.features.roommemberprofile.devices.DeviceListBottomSheetViewModel
import im.vector.umr.features.roomprofile.RoomProfileViewModel
import im.vector.umr.features.roomprofile.alias.RoomAliasViewModel
import im.vector.umr.features.roomprofile.alias.detail.RoomAliasBottomSheetViewModel
import im.vector.umr.features.roomprofile.banned.RoomBannedMemberListViewModel
import im.vector.umr.features.roomprofile.members.RoomMemberListViewModel
import im.vector.umr.features.roomprofile.notifications.RoomNotificationSettingsViewModel
import im.vector.umr.features.roomprofile.permissions.RoomPermissionsViewModel
import im.vector.umr.features.roomprofile.settings.RoomSettingsViewModel
import im.vector.umr.features.roomprofile.settings.joinrule.advanced.RoomJoinRuleChooseRestrictedViewModel
import im.vector.umr.features.roomprofile.uploads.RoomUploadsViewModel
import im.vector.umr.features.settings.account.deactivation.DeactivateAccountViewModel
import im.vector.umr.features.settings.crosssigning.CrossSigningSettingsViewModel
import im.vector.umr.features.settings.devices.DeviceVerificationInfoBottomSheetViewModel
import im.vector.umr.features.settings.devices.DevicesViewModel
import im.vector.umr.features.settings.devtools.AccountDataViewModel
import im.vector.umr.features.settings.devtools.GossipingEventsPaperTrailViewModel
import im.vector.umr.features.settings.devtools.KeyRequestListViewModel
import im.vector.umr.features.settings.devtools.KeyRequestViewModel
import im.vector.umr.features.settings.font.FontScaleSettingViewModel
import im.vector.umr.features.settings.homeserver.HomeserverSettingsViewModel
import im.vector.umr.features.settings.ignored.IgnoredUsersViewModel
import im.vector.umr.features.settings.legals.LegalsViewModel
import im.vector.umr.features.settings.locale.LocalePickerViewModel
import im.vector.umr.features.settings.push.PushGatewaysViewModel
import im.vector.umr.features.settings.threepids.ThreePidsSettingsViewModel
import im.vector.umr.features.share.IncomingShareViewModel
import im.vector.umr.features.signout.soft.SoftLogoutViewModel
import im.vector.umr.features.spaces.SpaceListViewModel
import im.vector.umr.features.spaces.SpaceMenuViewModel
import im.vector.umr.features.spaces.create.CreateSpaceViewModel
import im.vector.umr.features.spaces.explore.SpaceDirectoryViewModel
import im.vector.umr.features.spaces.invite.SpaceInviteBottomSheetViewModel
import im.vector.umr.features.spaces.leave.SpaceLeaveAdvancedViewModel
import im.vector.umr.features.spaces.manage.SpaceAddRoomsViewModel
import im.vector.umr.features.spaces.manage.SpaceManageRoomsViewModel
import im.vector.umr.features.spaces.manage.SpaceManageSharedViewModel
import im.vector.umr.features.spaces.people.SpacePeopleViewModel
import im.vector.umr.features.spaces.preview.SpacePreviewViewModel
import im.vector.umr.features.spaces.share.ShareSpaceViewModel
import im.vector.umr.features.start.StartAppViewModel
import im.vector.umr.features.terms.ReviewTermsViewModel
import im.vector.umr.features.usercode.UserCodeSharedViewModel
import im.vector.umr.features.userdirectory.UserListViewModel
import im.vector.umr.features.widgets.WidgetViewModel
import im.vector.umr.features.widgets.permissions.RoomWidgetPermissionViewModel
import im.vector.umr.features.workers.signout.ServerBackupStatusViewModel
import im.vector.umr.features.workers.signout.SignoutCheckViewModel
