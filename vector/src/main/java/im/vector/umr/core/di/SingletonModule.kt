...
import im.vector.umr.BuildConfig
import im.vector.umr.EmojiCompatWrapper
import im.vector.umr.EmojiSpanify
import im.vector.umr.SpaceStateHandler
import im.vector.umr.SpaceStateHandlerImpl
import im.vector.umr.config.Config
import im.vector.umr.core.dispatchers.CoroutineDispatchers
import im.vector.umr.core.error.DefaultErrorFormatter
...
import im.vector.umr.core.time.DefaultClock
import im.vector.umr.core.utils.AndroidSystemSettingsProvider
import im.vector.umr.core.utils.SystemSettingsProvider
import im.vector.umr.features.analytics.AnalyticsTracker
import im.vector.umr.features.analytics.VectorAnalytics
import im.vector.umr.features.analytics.impl.DefaultVectorAnalytics
import im.vector.umr.features.invite.AutoAcceptInvites
import im.vector.umr.features.invite.CompileTimeAutoAcceptInvites
import im.vector.umr.features.navigation.DefaultNavigator
import im.vector.umr.features.navigation.Navigator
import im.vector.umr.features.pin.PinCodeStore
import im.vector.umr.features.pin.SharedPrefPinCodeStore
import im.vector.umr.features.room.VectorRoomDisplayNameFallbackProvider
...
import im.vector.umr.features.ui.SharedPreferencesUiStateRepository
import im.vector.umr.features.ui.UiStateRepository
import im.vector.umr.flipper.FlipperProxy
