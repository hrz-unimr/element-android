...
package im.vector.umr.features
...
import im.vector.umr.core.extensions.startSyncing
import im.vector.umr.core.extensions.vectorStore
import im.vector.umr.core.platform.VectorBaseActivity
import im.vector.umr.core.utils.deleteAllFiles
import im.vector.umr.databinding.ActivityMainBinding
import im.vector.umr.features.analytics.VectorAnalytics
import im.vector.umr.features.home.HomeActivity
import im.vector.umr.features.home.ShortcutsHandler
...
import im.vector.umr.features.session.VectorSessionStore
import im.vector.umr.features.settings.VectorPreferences
import im.vector.umr.features.signout.hard.SignedOutActivity
import im.vector.umr.features.start.StartAppAction
import im.vector.umr.features.start.StartAppAndroidService
import im.vector.umr.features.start.StartAppViewEvent
import im.vector.umr.features.start.StartAppViewModel
import im.vector.umr.features.start.StartAppViewState
