...
package im.vector.umr.features.spaces.manage
...
import im.vector.umr.databinding.FragmentRoomSettingGenericBinding
import im.vector.umr.features.home.AvatarRenderer
import im.vector.umr.features.roomprofile.RoomProfileArgs
import im.vector.umr.features.roomprofile.settings.RoomSettingsAction
import im.vector.umr.features.roomprofile.settings.RoomSettingsViewEvents
import im.vector.umr.features.roomprofile.settings.RoomSettingsViewModel
import im.vector.umr.features.roomprofile.settings.RoomSettingsViewState
import im.vector.umr.features.roomprofile.settings.joinrule.RoomJoinRuleActivity
