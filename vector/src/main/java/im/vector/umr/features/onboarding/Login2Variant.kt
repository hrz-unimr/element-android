...
package im.vector.umr.features.onboarding
...
import im.vector.umr.core.extensions.POP_BACK_STACK_EXCLUSIVE
import im.vector.umr.core.extensions.addFragment
import im.vector.umr.core.extensions.addFragmentToBackstack
import im.vector.umr.core.extensions.resetBackstack
import im.vector.umr.core.platform.VectorBaseActivity
import im.vector.umr.databinding.ActivityLoginBinding
import im.vector.umr.features.home.HomeActivity
import im.vector.umr.features.login.LoginCaptchaFragmentArgument
import im.vector.umr.features.login.LoginConfig
import im.vector.umr.features.login.LoginGenericTextInputFormFragmentArgument
import im.vector.umr.features.login.LoginWaitForEmailFragmentArgument
import im.vector.umr.features.login.TextInputFormFragmentMode
import im.vector.umr.features.login.isSupported
import im.vector.umr.features.login.terms.LoginTermsFragmentArgument
import im.vector.umr.features.login2.LoginAction2
...
import im.vector.umr.features.login2.LoginViewEvents2
import im.vector.umr.features.login2.LoginViewModel2
import im.vector.umr.features.login2.LoginViewState2
