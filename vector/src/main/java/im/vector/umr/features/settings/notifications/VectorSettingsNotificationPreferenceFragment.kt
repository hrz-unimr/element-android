...
package im.vector.umr.features.settings.notifications
...
import im.vector.umr.core.preference.VectorEditTextPreference
...
import im.vector.umr.core.utils.combineLatest
...
import im.vector.umr.features.settings.BackgroundSyncModeChooserDialog
import im.vector.umr.features.settings.VectorPreferences
import im.vector.umr.features.settings.VectorSettingsBaseFragment
import im.vector.umr.features.settings.VectorSettingsFragmentInteractionListener
