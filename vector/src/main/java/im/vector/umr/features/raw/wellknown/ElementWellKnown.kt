...
package im.vector.umr.features.raw.wellknown
...
data class E2EWellKnownConfig(
        ...
        /**
         * Configuration for sharing keys strategy which should be used instead of [im.vector.umr.config.Config.KEY_SHARING_STRATEGY].
