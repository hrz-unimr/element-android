...
package im.vector.umr.features.location.live.map
...
import im.vector.umr.core.extensions.addChildFragment
...
import im.vector.umr.databinding.FragmentLiveLocationMapViewBinding
import im.vector.umr.features.location.LocationData
import im.vector.umr.features.location.UrlMapProvider
import im.vector.umr.features.location.zoomToBounds
import im.vector.umr.features.location.zoomToLocation
...
class LiveLocationMapViewFragment @Inject constructor() : VectorBaseFragment<FragmentLiveLocationMapViewBinding>() {
    ...
    companion object {
        private const val MAP_FRAGMENT_TAG = "im.vector.umr.features.location.live.map"
