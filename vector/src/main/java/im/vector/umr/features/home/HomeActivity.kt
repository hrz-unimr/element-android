...
package im.vector.umr.features.home
...
import im.vector.umr.core.extensions.replaceFragment
import im.vector.umr.core.extensions.validateBackPressed
import im.vector.umr.core.platform.VectorBaseActivity
...
import im.vector.umr.core.utils.startSharePlainTextIntent
import im.vector.umr.databinding.ActivityHomeBinding
import im.vector.umr.features.MainActivity
import im.vector.umr.features.MainActivityArgs
...
import im.vector.umr.features.disclaimer.showDisclaimerDialog
...
import im.vector.umr.features.onboarding.AuthenticationDescription
import im.vector.umr.features.permalink.NavigationInterceptor
import im.vector.umr.features.permalink.PermalinkHandler
import im.vector.umr.features.permalink.PermalinkHandler.Companion.MATRIX_TO_CUSTOM_SCHEME_URL_BASE
import im.vector.umr.features.permalink.PermalinkHandler.Companion.ROOM_LINK_PREFIX
import im.vector.umr.features.permalink.PermalinkHandler.Companion.USER_LINK_PREFIX
import im.vector.umr.features.popup.DefaultVectorAlert
import im.vector.umr.features.popup.PopupAlertManager
import im.vector.umr.features.popup.VerificationVectorAlert
import im.vector.umr.features.rageshake.ReportType
import im.vector.umr.features.rageshake.VectorUncaughtExceptionHandler
import im.vector.umr.features.settings.VectorPreferences
import im.vector.umr.features.settings.VectorSettingsActivity
import im.vector.umr.features.spaces.SpaceCreationActivity
import im.vector.umr.features.spaces.SpacePreviewActivity
import im.vector.umr.features.spaces.SpaceSettingsMenuBottomSheet
import im.vector.umr.features.spaces.invite.SpaceInviteBottomSheet
...
import im.vector.umr.nightly.NightlyProxy
import im.vector.umr.push.fcm.FcmHelper
