...
package im.vector.umr.features.location
...
import im.vector.umr.core.utils.PERMISSIONS_FOR_FOREGROUND_LOCATION_SHARING
...
import im.vector.umr.databinding.FragmentLocationSharingBinding
...
import im.vector.umr.features.location.live.LiveLocationLabsFlagPromotionBottomSheet
import im.vector.umr.features.location.live.duration.ChooseLiveDurationBottomSheet
import im.vector.umr.features.location.live.tracking.LocationSharingAndroidService
import im.vector.umr.features.location.option.LocationSharingOption
