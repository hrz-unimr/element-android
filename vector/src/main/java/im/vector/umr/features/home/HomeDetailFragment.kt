...
import im.vector.umr.core.extensions.commitTransaction
import im.vector.umr.core.extensions.toMvRxBundle
import im.vector.umr.core.platform.OnBackPressed
...
import im.vector.umr.core.ui.views.KeysBackupBanner
import im.vector.umr.databinding.FragmentHomeDetailBinding
import im.vector.umr.features.call.SharedKnownCallsViewModel
import im.vector.umr.features.call.VectorCallActivity
import im.vector.umr.features.call.dialpad.DialPadFragment
import im.vector.umr.features.call.webrtc.WebRtcCallManager
import im.vector.umr.features.home.room.list.RoomListFragment
import im.vector.umr.features.home.room.list.RoomListParams
import im.vector.umr.features.home.room.list.UnreadCounterBadgeView
import im.vector.umr.features.popup.PopupAlertManager
import im.vector.umr.features.popup.VerificationVectorAlert
import im.vector.umr.features.settings.VectorLocale
import im.vector.umr.features.settings.VectorPreferences
import im.vector.umr.features.settings.VectorSettingsActivity.Companion.EXTRA_DIRECT_ACCESS_SECURITY_PRIVACY_MANAGE_SESSIONS
import im.vector.umr.features.themes.ThemeUtils
import im.vector.umr.features.workers.signout.BannerState
