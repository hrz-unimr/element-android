...
import im.vector.umr.core.extensions.clearErrorOnChange
import im.vector.umr.core.extensions.content
import im.vector.umr.core.extensions.editText
import im.vector.umr.core.extensions.hasSurroundingSpaces
import im.vector.umr.core.extensions.hideKeyboard
import im.vector.umr.core.extensions.hidePassword
import im.vector.umr.core.extensions.isMatrixId
import im.vector.umr.core.extensions.onTextChange
import im.vector.umr.core.extensions.realignPercentagesToParent
import im.vector.umr.core.extensions.setOnFocusLostListener
import im.vector.umr.core.extensions.setOnImeDoneListener
import im.vector.umr.core.extensions.toReducedUrl
import im.vector.umr.databinding.FragmentFtueCombinedRegisterBinding
import im.vector.umr.features.login.LoginMode
import im.vector.umr.features.login.SSORedirectRouterActivity
import im.vector.umr.features.login.SocialLoginButtonsView
import im.vector.umr.features.login.render
import im.vector.umr.features.onboarding.OnboardingAction
import im.vector.umr.features.onboarding.OnboardingAction.AuthenticateAction
