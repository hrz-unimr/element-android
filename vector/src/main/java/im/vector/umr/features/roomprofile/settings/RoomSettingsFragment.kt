...
package im.vector.umr.features.roomprofile.settings
...
import im.vector.umr.features.roomprofile.settings.historyvisibility.RoomHistoryVisibilityBottomSheet
