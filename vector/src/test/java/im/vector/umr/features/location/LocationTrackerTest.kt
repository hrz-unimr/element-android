...
import im.vector.umr.test.fakes.FakeLocationManager
import im.vector.umr.test.fixtures.aBuildMeta
...
class LocationTrackerTest {
    ...
    @Before
    fun setUp() {
        mockkStatic("im.vector.umr.features.session.SessionCoroutineScopesKt")
