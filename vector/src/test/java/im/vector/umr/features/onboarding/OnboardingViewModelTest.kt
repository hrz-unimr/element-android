...
import im.vector.umr.features.login.LoginMode
import im.vector.umr.features.login.ReAuthHelper
import im.vector.umr.features.login.SignMode
import im.vector.umr.features.onboarding.StartAuthenticationFlowUseCase.StartAuthenticationResult
import im.vector.umr.test.TestBuildVersionSdkIntProvider
import im.vector.umr.test.fakes.FakeActiveSessionHolder
import im.vector.umr.test.fakes.FakeAnalyticsTracker
import im.vector.umr.test.fakes.FakeAuthenticationService
import im.vector.umr.test.fakes.FakeContext
import im.vector.umr.test.fakes.FakeDirectLoginUseCase
import im.vector.umr.test.fakes.FakeHomeServerConnectionConfigFactory
import im.vector.umr.test.fakes.FakeHomeServerHistoryService
import im.vector.umr.test.fakes.FakeLoginWizard
import im.vector.umr.test.fakes.FakeRegistrationActionHandler
import im.vector.umr.test.fakes.FakeRegistrationWizard
import im.vector.umr.test.fakes.FakeSession
import im.vector.umr.test.fakes.FakeStartAuthenticationFlowUseCase
import im.vector.umr.test.fakes.FakeStringProvider
import im.vector.umr.test.fakes.FakeUri
import im.vector.umr.test.fakes.FakeUriFilenameResolver
import im.vector.umr.test.fakes.FakeVectorFeatures
import im.vector.umr.test.fakes.FakeVectorOverrides
import im.vector.umr.test.fakes.toTestString
import im.vector.umr.test.fixtures.a401ServerError
import im.vector.umr.test.fixtures.aHomeServerCapabilities
import im.vector.umr.test.test
