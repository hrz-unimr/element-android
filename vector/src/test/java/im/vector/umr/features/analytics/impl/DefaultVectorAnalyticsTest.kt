...
package im.vector.umr.features.analytics.impl

import com.posthog.android.Properties
import im.vector.umr.features.analytics.itf.VectorAnalyticsEvent
import im.vector.umr.features.analytics.itf.VectorAnalyticsScreen
import im.vector.umr.test.fakes.FakeAnalyticsStore
import im.vector.umr.test.fakes.FakeLateInitUserPropertiesFactory
import im.vector.umr.test.fakes.FakePostHog
import im.vector.umr.test.fakes.FakePostHogFactory
import im.vector.umr.test.fixtures.AnalyticsConfigFixture.anAnalyticsConfig
import im.vector.umr.test.fixtures.aUserProperties
import im.vector.umr.test.fixtures.aVectorAnalyticsEvent
import im.vector.umr.test.fixtures.aVectorAnalyticsScreen
