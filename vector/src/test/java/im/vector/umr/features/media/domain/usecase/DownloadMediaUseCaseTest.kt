...
package im.vector.umr.features.media.domain.usecase
...
import im.vector.umr.test.fakes.FakeClock
import im.vector.umr.test.fakes.FakeFile
...
class DownloadMediaUseCaseTest {
    ...
    fun setUp() {
        ...
        mockkStatic("im.vector.umr.core.utils.ExternalApplicationsUtilKt")
        mockkStatic("im.vector.umr.core.intent.VectorMimeTypeKt")
    }

    @After
    fun tearDown() {
        unmockkStatic("im.vector.umr.core.utils.ExternalApplicationsUtilKt")
        unmockkStatic("im.vector.umr.core.intent.VectorMimeTypeKt")
        file.tearDown()
    }
