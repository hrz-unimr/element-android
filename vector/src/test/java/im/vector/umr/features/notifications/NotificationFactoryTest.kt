...
import im.vector.umr.features.notifications.ProcessedEvent.Type
import im.vector.umr.test.fakes.FakeNotificationUtils
import im.vector.umr.test.fakes.FakeRoomGroupMessageCreator
import im.vector.umr.test.fakes.FakeSummaryGroupMessageCreator
import im.vector.umr.test.fixtures.aNotifiableMessageEvent
import im.vector.umr.test.fixtures.aSimpleNotifiableEvent
import im.vector.umr.test.fixtures.anInviteNotifiableEvent
